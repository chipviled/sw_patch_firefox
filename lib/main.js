...
var c_scripts = [data.url("js/photoswipe.js"),
                 data.url("js/photoswipe-ui-default.js"),
                 data.url("js/photoswipe-init.js"),
                 data.url("js/jquery-2.1.4.min.js"),
                 data.url("js/common.js")
];

var c_css = [data.url("css/add.css"),
             data.url("css/photoswipe.css")
];
...
var popup = panels.Panel({
    ...
    contentScriptFile: [data.url("js/jquery-2.1.4.min.js"),
